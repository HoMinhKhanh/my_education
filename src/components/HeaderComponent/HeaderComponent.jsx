...
const HeaderComponent = () => {
    ...
    const contentCourse = (
        <div>
          <h3 style={{alignItems: 'center',display: 'flex',padding: '14px 20px 16px'}}>Danh sách khóa học</h3>
          <div style={{width:'300px', display: 'flex'}}>
            <img src="https://i.ytimg.com/vi/GdAyat5P72Q/hq720.jpg?sqp=-oaymwEcCOgCEMoBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLAdohuZvfmbvPqKll8wmbE84ryU0w" 
            alt="" style={{width: '200px'}}/>
            <p style={{flex: '1 1', margin: '12px'}}>Hàm số toán 12</p>
          </div>
        </div>
    );
                    ...
                    <LoadingComponent isLoading={loading} >
                        <WrapperHeaderAccount>
                            <div>
                                ...
                                <Popover placement="bottom" content={contentCourse} trigger="click">                                   
